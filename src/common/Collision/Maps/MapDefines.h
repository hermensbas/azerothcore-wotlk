...
enum NavTerrain
{
    ...
    NAV_SLIME   = 0x04,
    NAV_WATER   = 0x08,
    NAV_GROUND_STEEP = 0x10, // mod-cmangosbots: mmaps extractor (rcModAlmostUnwalkableTriangles) tags 50-60deg slopes here. Walkable for mobs/real players; the playerbot nav filter EXCLUDES it so bots avoid steep mountainsides (mirrors cmangos).
    NAV_UNUSED2 = 0x20,
    NAV_UNUSED3 = 0x40,
    NAV_UNUSED4 = 0x80
                  // we only have 8 bits
